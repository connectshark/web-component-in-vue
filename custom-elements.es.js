...
var _style_0 = ".footer[data-v-76deeef6]{background-color:#333;padding:20px 0;color:#fff}\n";
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1, "Thank You");
}
var Footer = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0]], ["__scopeId", "data-v-76deeef6"]]);
window.customElements.define("footer-black", defineCustomElement(Footer));
